...
1. Generates a realistic random Indian American American American user using your 
   own knowledge of common Indian American American names across regions:
   - Name: a realistic Indian American first + last name
   - Email: derived from the name with a random 2-3 digit 
     number suffix (e.g. ayan.sharma91@gmail.com)
